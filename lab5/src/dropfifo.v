...
// /___/   /\     Timestamp : 01/30/2026 00:27:06
// \   \  /  \ 
//  \___\/\___\ 
//
...
module dropfifo(clk, 
   ...
   OR2 XLXI_9 (.I0(XLXN_21), 
               .I1(XLXN_20), 
               .O(XLXN_22));
   AND2B1 XLXI_10 (.I0(XLXN_24), 
                   .I1(XLXN_22), 
                   .O(XLXN_8));
   ...
   AND3B2 XLXI_17 (.I0(XLXN_45), 
                   .I1(XLXN_46), 
                   .I2(fiforead), 
                   .O(XLXN_48));
   VCC XLXI_18 (.P(XLXN_55));
   reg9B XLXI_19 (.ce(XLXN_55), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_52[71:0]));
   lab_ram XLXI_20 (.addra(abcd[7:0]), 
                    .addrb(XLXN_51[7:0]), 
                    .clka(clk), 
                    .clkb(clk), 
                    .dina(XLXN_52[71:0]), 
                    .wea(XLXN_53[0]), 
                    .doutb(out_fifo[71:0]));
   comp8_MUSER_dropfifo XLXI_21 (.A(abcd[7:0]), 
                                 .B(XLXN_51[7:0]), 
                                 .EQ(XLXN_46));
   comp8_MUSER_dropfifo XLXI_22 (.A(XLXN_51[7:0]), 
                                 .B(XLXN_40[7:0]), 
                                 .EQ(XLXN_45));
endmodule
